package com.terseinc.graph.functional;
...
public class PhotoAblumPermission {
	public User user;
	public JSONObject obj;
	public String photoToken = TokenManager.get_photo_Token();
	final static Logger logger = Logger.getLogger(PhotoAblumPermission.class);
    ...
    public void TestThatIfNoFieldsAreSpecifiedForTheMeEndPointTheIDAndNameOfCurrentUserIsReturned(){
    	 String endpoint = "me";
    	 String fieldQuery = "albums.limit(5),posts.limit(5)";
	     Response response = user.getResponseFromEndPoint(endpoint, fieldQuery, photoToken);
	     String body = response.readEntity(String.class);
	     Assert.assertEquals(200, response.getStatus());
